...
/*   Updated: 2023/01/04 10:25:15 by momeaizi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const char* Form::GradeTooLowToSignFormException::what() const _NOEXCEPT
{
...
{
    if (executor.getGrade() > gradeRequiredToSignIt)
        throw GradeTooLowToSignFormException();

    if (executor.getGrade() > gradeRequiredToExecuteIt)
        throw GradeTooLowException();
